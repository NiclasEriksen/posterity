...
GRAPHIC_TAGS = ["death", "graphic", "violence", "gore", "nudity", "corpses", "blood"]
EMOTIONAL_TAGS = ["censored graphic", "distress", "animals", "children", "sexual", "shock", "emotional"]
INFORMATIONAL_TAGS = []
...
GRAPHIC_COLOR = (231, 53, 75)
EMOTIONAL_COLOR = (217, 163, 34)
FONT_GS = 128
GRAPHIC_GS = 0
EMOTIONAL_GS = 64
